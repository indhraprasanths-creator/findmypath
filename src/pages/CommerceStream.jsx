  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      <section className="bg-gradient-to-r from-purple-700 to-purple-500 text-white p-12 flex flex-col md:flex-row items-center justify-between">
        <div>
          <h1 className="text-6xl font-bold leading-tight">COMMERCE</h1>
          <h2 className="text-4xl font-semibold mt-2">STREAM</h2>
          <p className="mt-6 max-w-lg">
            This stream is for students who are interested in pursuing careers in fields like finance,
            business management, economics, banking, marketing, and more.
          </p>
      ...
      <div className="bg-blue-300 flex flex-wrap justify-center p-4 gap-4">
        {['ACCOUNTANCY', 'ECONOMICS', 'BUSINESS STUDIES', 'FINANCE', 'MARKETING'].map((item) => (
      ...
      <section className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-gray-100 p-6 rounded-lg">
          <h3 className="font-bold text-lg mb-4">SUBJECTS IN COMMERCE:</h3>
          <ul className="list-disc list-inside space-y-2">
            <li>Accountancy</li>
            <li>Business Studies</li>
            <li>Economics</li>
            <li>Mathematics (optional, but recommended)</li>
            <li>English</li>
